...
public class Meowth extends Pokemon {
    public Meowth(String name, int hp, int normalAttack, int specialAttack, int defense, int specialDefense,
    ...
    @Override
    public Pokemon copy() {
        return new Meowth(this.getName(), this.getHp(), this.getNormalAttack(),
