...
public class Eevee extends Pokemon {
    public Eevee(String name, int hp, int normalAttack, int specialAttack, int defense, int specialDefense,
    ...
    @Override
    public Pokemon copy() {
        return new Eevee(this.getName(), this.getHp(), this.getNormalAttack(),
