...
public class Snorlax extends Pokemon {
    public Snorlax(String name, int hp, int normalAttack, int specialAttack, int defense, int specialDefense,
    ...
    @Override
    public Pokemon copy() {
        return new Snorlax(this.getName(), this.getHp(), this.getNormalAttack(),
