...
public class Pikachu extends Pokemon {
    public Pikachu(String name, int hp, int normalAttack, int specialAttack, int defense, int specialDefense,
    ...
    @Override
    public Pokemon copy() {
        return new Pikachu(this.getName(), this.getHp(), this.getNormalAttack(),
