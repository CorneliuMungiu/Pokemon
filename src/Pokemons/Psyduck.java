...
public class Psyduck extends Pokemon {
    public Psyduck(String name, int hp, int normalAttack, int specialAttack, int defense, int specialDefense,
    ...
    @Override
    public Pokemon copy() {
        return new Psyduck(this.getName(), this.getHp(), this.getNormalAttack(),
